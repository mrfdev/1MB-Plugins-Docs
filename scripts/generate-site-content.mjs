  ...
  const groups = [
    {
      ...
      rows: [
        ...
        ['Hero Quartz Chestplate', 'Chainmail chestplate', 'V to X', 'After Unbreaking X', 'Available', 'Protection V to VI; Netherite chestplate'],
    ...
    },
    {
      ...
      rows: [
        ...
        ['Elite Quartz Boots', 'Chainmail boots', 'V to X', 'After Unbreaking X', 'Available', 'Protection VI; Netherite boots'],
