---
title: "BSkyBlock Staff Reference"
description: "Public-safe commands, permissions, configuration, integrations, and troubleshooting notes for BSkyBlock."
---

BSkyBlock is loaded as a BentoBox game-mode add-on. Administration is namespaced under the configured player and admin commands for that mode.
...
| --- | --- | --- |
| `/is admin` | `bskyblock.admin.*` | Shows the mode administration surface; the exact admin alias is configurable. |
...
- [Player guide](/player-guides/other-server-features/bskyblock/)
- [Curated source notes](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/catalog/other-server-features/bskyblock/)
