---
title: "Bedrock Access (Geyser and floodgate) Staff Reference"
description: "Public-safe commands, permissions, configuration, integrations, and troubleshooting notes for Bedrock Access (Geyser and floodgate)."
---
...
- [Player guide](/player-guides/other-server-features/bedrock-access/)
- [Curated source notes](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/catalog/other-server-features/bedrock-access/)
- [Official plugin documentation](https://geysermc.org/wiki/)
