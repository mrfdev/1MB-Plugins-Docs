---
title: "BentoBox Biomes Staff Reference"
description: "Public-safe commands, permissions, configuration, integrations, and troubleshooting notes for BentoBox Biomes."
---

BentoBox Biomes is administered as a BentoBox add-on. Its command labels and permission prefix may be generated per hooked game mode.
...
| --- | --- | --- |
| `bentobox.biomes.*` | Generated biome access for hooked game modes. | Player ranks, selectively |
...
- Economy pricing may be applied to biome changes.
- Biome command prefixes are generated for each hooked game mode.
...
- [BentoBox Biomes source](https://github.com/BentoBoxWorld/Biomes)

## Reference Links

- [Player guide](/player-guides/other-server-features/biomes/)
- [Curated source notes](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/catalog/other-server-features/biomes/)
- [Official plugin documentation](https://github.com/BentoBoxWorld/Biomes)
