---
title: "BentoBox Challenges Guide"
description: "Offer structured island tasks, progression tiers, and configured rewards."
---

BentoBox Challenges is a BentoBox add-on used by one or more 1MoreBlock island game modes. It extends an island rather than creating a separate server world of its own.
...
- Challenge menus grouped by level or category.
- One-time, repeatable, or prerequisite-based objectives.
- Item, currency, permission, and command rewards where configured.
...
- [Staff and technical reference](/staff-reference/other-server-features/challenges/)
- [1MoreBlock feature notes](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/catalog/other-server-features/challenges/)
- [Official plugin documentation](https://github.com/BentoBoxWorld/Challenges)
