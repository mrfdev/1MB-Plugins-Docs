---
title: "BentoBox TopBlock Guide"
description: "Rank OneBlock islands by their highest reached block or configured phase progress."
---

BentoBox TopBlock is a BentoBox add-on used by one or more 1MoreBlock island game modes. It extends an island rather than creating a separate server world of its own.
...
- OneBlock-focused top ranking.
- Leaderboard output suitable for commands and displays.
- Cached ranking updates tied to OneBlock progress.
...
- [Staff and technical reference](/staff-reference/other-server-features/topblock/)
- [1MoreBlock feature notes](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/catalog/other-server-features/topblock/)
