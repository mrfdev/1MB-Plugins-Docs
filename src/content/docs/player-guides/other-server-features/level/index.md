---
title: "BentoBox Level Guide"
description: "Calculate island value and provide personal and server-wide island rankings."
---

BentoBox Level is a BentoBox add-on used by one or more 1MoreBlock island game modes. It extends an island rather than creating a separate server world of its own.
...
- Scans configured island blocks and applies value rules.
- Personal island-level checks and top-island rankings.
- Death penalties, visit requirements, and calculation cooldowns where configured.
...
- [Staff and technical reference](/staff-reference/other-server-features/level/)
- [1MoreBlock feature notes](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/catalog/other-server-features/level/)
- [Official plugin documentation](https://github.com/BentoBoxWorld/Level)
