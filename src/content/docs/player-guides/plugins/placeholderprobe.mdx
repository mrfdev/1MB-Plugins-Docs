...
The [full synced PlaceholderProbe reference](https://github.com/mrfdev/1MB-Plugins-Docs/blob/main/project-docs/cmi-api/docs/plugins/placeholderprobe.md) is available for exact technical details.
