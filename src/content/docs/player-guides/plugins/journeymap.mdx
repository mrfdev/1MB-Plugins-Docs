...
4. Try `/journeymap path` when you are ready to use one of the feature actions.
...
The [full synced JourneyMap reference](https://github.com/mrfdev/1MB-Plugins-Docs/blob/main/project-docs/cmi-api/docs/plugins/journeymap.md) is available for exact technical details.
