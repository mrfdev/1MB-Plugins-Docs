---
title: "XMas Tree Guide"
description: "Plant, grow, and celebrate upgradeable Christmas trees with presents, streaks, milestones, and preserved legacy event trees."
---
...
- [Technical overview](https://github.com/mrfdev/1MB-Plugins-Docs/blob/main/project-docs/xmas-tree/README.md)
- [Technical documentation folder](https://github.com/mrfdev/1MB-Plugins-Docs/tree/main/project-docs/xmas-tree/docs/)
