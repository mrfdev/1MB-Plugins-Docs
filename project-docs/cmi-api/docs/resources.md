...
This project builds companion plugins for CMI using CMI-API, CMILib, and modern Paper APIs.

## CMI

- CMI documentation: https://www.zrips.net/cmi/
...
These may be used when CMI, CMI-API, or CMILib do not provide the needed surface:
...
- spark docs: https://spark.lucko.me/docs/
