...
The current release baseline is Java 25 bytecode built with JDK 25.0.4, compatibility-smoked on JDK 26.0.2, and Paper 26.2 stable build 121 or newer. Gradle compiles against `paper-api:26.2.build.121-stable`.
...
For every new local test build, stop Paper and run:
...
```text
1MB-Lib-Core-v1.0.3-636-j25-26.2.jar
1MB-Lib-AntiFire-v1.0.3-636-j25-26.2.jar
1MB-Lib-AFKShrine-v1.0.3-636-j25-26.2.jar
1MB-Lib-RecordingMode-v1.0.3-636-j25-26.2.jar
1MB-Lib-SellStreaks-v1.0.3-636-j25-26.2.jar
1MB-Lib-ScheduledTips-v1.0.3-636-j25-26.2.jar
1MB-Lib-Visit-v1.0.3-636-j25-26.2.jar
1MB-Lib-PassportDiscovery-v1.0.3-636-j25-26.2.jar
1MB-Lib-SocialGatherings-v1.0.3-636-j25-26.2.jar
1MB-Lib-JourneyMap-v1.0.3-636-j25-26.2.jar
1MB-Lib-KitStreaks-v1.0.3-636-j25-26.2.jar
1MB-Lib-Nick-v1.0.3-636-j25-26.2.jar
1MB-Lib-EmoteMenu-v1.0.3-636-j25-26.2.jar
1MB-Lib-PvPToggle-v1.0.3-636-j25-26.2.jar
1MB-Lib-Boosters-v1.0.3-636-j25-26.2.jar
1MB-Lib-NameMC-v1.0.3-636-j25-26.2.jar
1MB-Lib-Exchange-v1.0.3-636-j25-26.2.jar
1MB-Lib-VoteTokens-v1.0.3-636-j25-26.2.jar
1MB-Lib-DiscordChat-v1.0.3-636-j25-26.2.jar
1MB-Lib-GameTypes-v1.0.3-636-j25-26.2.jar
1MB-Lib-BirthdayLanterns-v1.0.3-636-j25-26.2.jar
1MB-Lib-LavaBoots-v1.0.3-636-j25-26.2.jar
1MB-Lib-Spawners-v1.0.3-636-j25-26.2.jar
1MB-Lib-Collect-v1.0.3-636-j25-26.2.jar
1MB-Lib-EventHunts-v1.0.3-636-j25-26.2.jar
1MB-Lib-DropParty-v1.0.3-636-j25-26.2.jar
1MB-Lib-Appreciation-v1.0.3-636-j25-26.2.jar
1MB-Lib-Forage-v1.0.3-636-j25-26.2.jar
1MB-Lib-MobHat-v1.0.3-636-j25-26.2.jar
1MB-Lib-PlayerTodo-v1.0.3-636-j25-26.2.jar
1MB-Lib-Refer-v1.0.3-636-j25-26.2.jar
1MB-Lib-TPAuto-v1.0.3-636-j25-26.2.jar
1MB-Lib-Menu-v1.0.3-636-j25-26.2.jar
1MB-Lib-StaffCenter-v1.0.3-636-j25-26.2.jar
1MB-Lib-Profile-v1.0.3-636-j25-26.2.jar
1MB-Lib-ContentGuard-v1.0.3-636-j25-26.2.jar
1MB-Lib-WarningLens-v1.0.3-636-j25-26.2.jar
1MB-Lib-TeamMsg-v1.0.3-636-j25-26.2.jar
1MB-Lib-CmdCostDashboard-v1.0.3-636-j25-26.2.jar
1MB-Lib-CMIConfig-v1.0.3-636-j25-26.2.jar
1MB-Lib-ConsoleNoiseRouter-v1.0.3-636-j25-26.2.jar
1MB-Lib-EconomyGuardian-v1.0.3-636-j25-26.2.jar
1MB-Lib-StartupDoctor-v1.0.3-636-j25-26.2.jar
1MB-Lib-UpdateSmoke-v1.0.3-636-j25-26.2.jar
1MB-Lib-PluginVersions-v1.0.3-636-j25-26.2.jar
1MB-Lib-Placeholders-v1.0.3-636-j25-26.2.jar
1MB-Lib-Potions-v1.0.3-636-j25-26.2.jar
1MB-Lib-Upgrade-v1.0.3-636-j25-26.2.jar
1MB-Lib-EndCrystals-v1.0.3-636-j25-26.2.jar
1MB-Lib-WorldSnapshot-v1.0.3-636-j25-26.2.jar
1MB-Lib-SparkReviewer-v1.0.3-636-j25-26.2.jar
1MB-Lib-Hoppers-v1.0.3-636-j25-26.2.jar
1MB-Lib-EventRecorder-v1.0.3-636-j25-26.2.jar
1MB-Lib-BedrockChatBridge-v1.0.3-636-j25-26.2.jar
1MB-Lib-CMIProbe-v1.0.3-636-j25-26.2.jar
1MB-Lib-CMIDatabase-v1.0.3-636-j25-26.2.jar
1MB-Lib-PermissionProbe-v1.0.3-636-j25-26.2.jar
1MB-Lib-WarpAudit-v1.0.3-636-j25-26.2.jar
1MB-Lib-WorthDrift-v1.0.3-636-j25-26.2.jar
1MB-Lib-WorthHelper-v1.0.3-636-j25-26.2.jar
```
...
Focused Gradle tests, compilation, and JAR tasks may be used while developing, but they do not create a deployable build. Direct `gradle build` is a repository verification command and does not increment or deploy the suite. If the canonical workflow fails, fix the cause and rerun it; the pending transaction keeps the same proposed build number rather than consuming another one.
...
The canonical `scripts/build-all.sh` command performs this synchronization after the complete build gate. With Paper stopped, either lower-level entry point can repair or redeploy the already-persisted build for both legacy `1MB-CMIAPI-*` and current `1MB-Lib-*` JAR families:
...
```text
https://github.com/mrfdev/1MB-Library
```
