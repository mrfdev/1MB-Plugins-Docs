...
| Player Fun | VoteTokens | `/votetokens` secure vote-token GUI exchanges with tier/layer progress, CMI kit rewards, hidden reward identity markers, extra-token item tools, two-stage Jobs 6/12 purchases under Other Upgrades, and staff migration tools | [VoteTokens](plugins/votetokens.md) |
