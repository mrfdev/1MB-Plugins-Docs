...
| Player Fun | CoconutHunt | `/coconut` seven-day Summer Beach event with 200 registered coconut heads, cumulative waves, immutable snapshots, personal collection and participation streak milestones, community goals, Coconut Points, safe claims, configurable MobHat offers, and transient CMI/Paper visuals | [Coconut Hunt](plugins/coconut.md) |
