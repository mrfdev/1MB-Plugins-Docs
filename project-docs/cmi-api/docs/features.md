...
| Player Fun | CoconutHunt | `/coconut` seven-day Summer Beach event in the shared themed-hunt engine, with 70 registered heads (10 per day), cumulative waves, immutable snapshots, history, personal/community rewards, Coconut Points, safe claims, an isolated debug workflow, and private Paper visuals | [Coconut Hunt](plugins/coconut.md) |
| Player Fun | GhostHunt | `/ghosthunt` Halloween edition in the same backward-compatible jar, with event-bound Ghost heads, private positional effects, accessibility modes, Haunting Chain point bonuses, guarded event activation, historical claims, and isolated debug data | [Halloween Ghost Hunt](plugins/ghosthunt.md) |
