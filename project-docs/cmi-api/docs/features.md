...
| Player Fun | CoconutHunt | `/coconut` seven-day Summer Beach event in the shared themed-hunt engine, with 200 registered heads, cumulative waves, immutable snapshots, history, personal/community rewards, Coconut Points, safe claims, an isolated debug workflow, and private Paper visuals | [Coconut Hunt](plugins/coconut.md) |
