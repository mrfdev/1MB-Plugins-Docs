...
The shared report includes commands, granular permissions, placeholders, config/data/cache paths, optional hooks, runtime health, and the active hologram provider. CoconutHunt targets Java 25 and Paper 26.2 stable build 129 or newer.
...
- [ ] Confirm Paper 26.2 stable build 129 or newer, Java 25, CMI, CMILib, and 1MB-CMIAPI-Lib are enabled.
