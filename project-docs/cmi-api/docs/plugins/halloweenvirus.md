...
Player guide: <https://docs.1moreblock.com/player-guides/plugins/halloweenvirus/>. Staff setup, permissions, recovery, and configuration are documented in [Halloween Virus administration](halloweenvirus-administration.md).
...
Fight in Survival and finish the encounter yourself. The credited killer must have recently damaged the infected mob and still be nearby. Environmental kills and automatic farm kills do not count. Friends can help and trade the resulting fragment, but the encounter does not create a separate reward for every party member.
