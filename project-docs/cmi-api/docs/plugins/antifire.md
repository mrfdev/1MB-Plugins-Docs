...
- Install `1MB-Lib-AntiFire-v1.0.3-575-j25-26.2.jar`. It shares the CMI-API build number and release pipeline, but it does not require CMI, CMILib, or `1MB-CMIAPI-Lib` at runtime.
...
```text
Jar: 1MB-Lib-AntiFire-v1.0.3-575-j25-26.2.jar
Java target: 25
